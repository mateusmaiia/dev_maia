export function About(){
  return(
    <div id="about" className="w-full flex bg-card items-center flex-col justify-center border border-y-white/10 h-4/6 py-20 mx-auto  ">
      <h2 className="text-center text-4xl font-semibold mb-6">Sobre</h2>
      <p className="text-center text-slate-400 text-lg md:text-lg w-4/6 max-w-3xl  font-light tracking-wider">
